...
var FormCore = class {
  ...
  _initValue(formValue, config, isRemoveValue = true, parentProp, key) {
    var _a;
    const values = {};
    (_a = config.filter((i) => {
      var _a2;
...
var Form = class extends FormCore {
  ...
  async setFormConfigs(newFormConfig, isRemoveValue = true) {
    ...
    setTimeout(() => {
      var _a;
      (_a = this.formRef.value) == null ? void 0 : _a.clearValidate();
    }, 0);
  }
  /**
   * 在指定位置添加表单配置项
        ...
        Object.entries(groupedByChildIndex).forEach(([childIndexStr, childItems]) => {
          ...
          if (childIndex < parentConfig.children.length) {
            ...
            indexesToRemove.forEach((index) => {
              ...
              if (isRemoveValue && this.formValue[parentProp] && this.formValue[parentProp][childIndex] && this.formValue[parentProp][childIndex][childProp] !== void 0) {
