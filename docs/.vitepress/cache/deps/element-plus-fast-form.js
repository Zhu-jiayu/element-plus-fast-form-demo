...
// node_modules/.pnpm/element-plus-fast-form@1.2.6_@element-plus+icons-vue@2.0.0_vue@3.5.16__element-plus@2.7.4_vue@3.5.16__vue@3.5.16/node_modules/element-plus-fast-form/dist/index.es.js
...
var groupRow = "_groupRow_1hdel_8";
var border = "_border_1hdel_13";
var operate = "_operate_1hdel_21";
var hasSuffix = "_hasSuffix_1hdel_27";
var styles = {
  groupRow,
  border,
  operate,
...
var FormCore = class {
  ...
  _isNoFormItemProps(itemConfig) {
    var _a;
    if (itemConfig.formItemProps.prop === "" || !((_a = itemConfig.formItemProps) == null ? void 0 : _a.prop)) {
      return true;
    }
    return false;
  }
  ...
  _initValue(formValue, config, parentProp, key) {
    ...
    (_a = config.filter((i) => {
      ...
      if (item.children) {
        ...
        const preValue = parentProp ? ((_b = (_a2 = formValue == null ? void 0 : formValue[parentProp]) == null ? void 0 : _a2[key]) == null ? void 0 : _b[item.formItemProps.prop]) || "" : formValue[item.formItemProps.prop];
...
if (typeof document !== "undefined") {
  const style = document.createElement("style");
  style.textContent = "._form-item_1hdel_1 :deep(._el-form-item__content_1hdel_1 > *){width:100%}._form-item_1hdel_1 .el-form-item__content>*{width:100%}._groupRow_1hdel_8{width:100%;padding:0 24px 24px}._border_1hdel_13{border:1px solid #dcdfe6;padding:12px 0;margin-bottom:12px;border-radius:8px;position:relative}._operate_1hdel_21{position:absolute;right:8px;bottom:8px}._hasSuffix_1hdel_27{display:flex;align-items:center}._hasSuffix_1hdel_27>*:last-child{margin-left:8px;font-size:14px}._hasSuffix_1hdel_27>*:first-child{flex:1;width:unset!important}\n";
  document.head.appendChild(style);
}
export {
